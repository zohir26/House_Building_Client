...
const PaymentHistory = () => {
    ...
    const { data: payments = [] } = useQuery({
        queryKey: ['payment'],
        queryFn: async () => {
            const res = await axiosSecure.get(`/payments/${user.email}`); // Ensure user.email is correctly set
            return res.data;
        },
    });
    ...
    return (
        <div className="p-5">
            <h1 className="text-2xl font-bold mb-4 text-center">Payment History: {payments.length}</h1>
